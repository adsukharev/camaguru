...
<div class="container profile">
    ...
    <div class="form signUp">
        ...
        <form name="SignUp" action="/profile/modify" method="post">
            <input type=text name="email" value='' placeholder="email" minlength="3" maxlength="20"
                   pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="example@mail.ru">
            <br>
            <input type=text name="login" value='' placeholder="login" minlength="3" maxlength="10">
            <br>
            <input type=text name="pass" value='' placeholder="password" minlength="3" maxlength="10">
            <br>
